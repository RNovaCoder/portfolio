/* eslint-disable no-func-assign, no-redeclare, @typescript-eslint/no-this-alias */
(function (global, factory) {
  typeof exports === "object" && typeof module !== "undefined"
    ...
    : typeof define === "function" && define.amd
      ...
      : ((global = global || self),
        factory((global["video-react"] = {}), global.React));
  ...
  */
  ...
  var Manager =
    ...
    (function () {
      ...
      _proto.subscribeToOperationStateChange =
        function subscribeToOperationStateChange(listener) {
          var _this = this;
      ...
      _proto.subscribeToPlayerStateChange =
        function subscribeToPlayerStateChange(listener) {
          var _this2 = this;
    ...
    (function (_Component) {
      ...
      function Video(props) {
        ...
        _this.handleProgress = throttle(
          _this.handleProgress.bind(_assertThisInitialized(_this)),
          250,
        );
        _this.handleKeypress = _this.handleKeypress.bind(
          _assertThisInitialized(_this),
        );
        _this.handleTextTrackChange = _this.handleTextTrackChange.bind(
          _assertThisInitialized(_this),
        );
        return _this;
      }
      ...
      _proto.handleTextTrackChange = function handleTextTrackChange() {
        ...
        if (this.video && this.video.textTracks) {
          var activeTextTrack = Array.from(this.video.textTracks).find(
            function (textTrack) {
  ...
  var Bezel =
    ...
    (function (_Component) {
      ...
      _proto.componentWillUnmount = function componentWillUnmount() {
        // Asegúrate de limpiar el temporizador cuando el componente se desmonta
        if (this.timer) {
        ...
        if (this.unsubscribe) {
          this.unsubscribe(); // Llama a la función de desuscripción que se guardó previamente
        }
      };
  ...
  function PopupButton(props) {
    props = _extends({}, defaultProps$4, props);
    var _props = props,
  ...
  PlaybackRateMenuButton.defaultProps = defaultProps$6;
  ...
  ControlBar.defaultProps = defaultProps$7;
    ...
    (function (_Component) {
      ...
      function Player(props) {
        ...
        _this.manager.subscribeToPlayerStateChange(
          _this.handleStateChange.bind(_assertThisInitialized(_this)),
        );
        ...
        _this.handleMouseMove = throttle(
          _this.handleMouseMove.bind(_assertThisInitialized(_this)),
          250,
        );
        _this.handleMouseDown = _this.handleMouseDown.bind(
          _assertThisInitialized(_this),
  ...
  Player.defaultProps = defaultProps$8;
  ...
  var ClosedCaptionButton =
    ...
    (function (_Component) {
      ...
      _proto.textTrackItemsAreEqual = function textTrackItemsAreEqual(
        items1,
        items2,
      ) {
  ...
  ClosedCaptionButton.defaultProps = defaultProps$9;
